...
from .common import CELL_VALUE_EMPTY, ExportPatternXlsxCommon
...
class TestPatternExport(ExportPatternXlsxCommon, SavepointCase):
    ...
    def test_export_m2m_headers(self):
        wb = self.get_exported_workbook(self.ir_exports_m2m, self.users)
    ...
    def test_export_o2m_headers(self):
        wb = self.get_exported_workbook(self.ir_exports_o2m, self.partners)
