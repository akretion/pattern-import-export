...
class TestSyncPattimpexImport(SyncPattimpexCommon):
    def setUp(self):
        ...
        self._inject_attachment("/fixtures/example.users.csv")
    ...
    def _inject_attachment(self, path):
        ...
        vals = {
            "name": "example.users.csv",
            "datas": attachment_data,
            "datas_fname": "example.users.csv",
    ...
    def test_import_state_correct(self):
        ...
        attachment = self._inject_attachment("/fixtures/example.users.csv")
        self.task_import.run_export()
